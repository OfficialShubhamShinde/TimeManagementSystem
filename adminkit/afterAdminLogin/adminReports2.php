    ...
    <div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand navbar-light navbar-bg">
                ...
                <h3 class="h3 mb-3"><strong> Manager Portal </strong> </h3>
...
?>
    ...
    <form action="adminReport3.php" method="POST">
        <div class="form-group">
            <label class="font-weight-bold">Select Fields:</label>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="date" id="Date">
                <label class="form-check-label" for="Date">Date</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="intime" id="InTime">
                <label class="form-check-label" for="InTime">In-Time</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="outtime" id="OutTime">
                <label class="form-check-label" for="OutTime">Out-Time</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="position" id="Role">
                <label class="form-check-label" for="Role">Position</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="project" id="Project">
                <label class="form-check-label" for="Project">Project</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="activity" id="Activity">
                <label class="form-check-label" for="Activity">Activity</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="description" id="Description">
                <label class="form-check-label" for="Description">Description</label>
            </div>
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="fields[]" value="hours" id="Hours">
    ...
    function downloadPDF() {
        ...
        Promise.all([
            html2canvas(head, { scale: 2, useCORS: true }),
        ...
        <script>
            function downloadExcel() {
                ...
                ws_data.push([], ["Date", "Hours", "Time From", "Time To", "Role", "Project Name", "Activity ID", "Activity Description"]); // add an empty row and the header row
        ...
        <script>
            function downloadExcel() {
                ...
                var ws_data = [
                    ["Report Header"],
                    [document.getElementById("report_head").innerText],
                    [],
                    ["Date", "Hours", "Time From", "Time To", "Role", "Project Name", "Activity ID", "Activity Description"]
                ];
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div id="report_head">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="card-text">Project Name: <b>Time Management System</b></p>
                                        </div>
                                        <div class="col-md-6">
        ...
        <div class="card">
            ...
            // Create an array to keep track of the dates
            $dates = array();
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if (!in_array($row['date'], $dates)) {
                    ...
                    echo "<td>UI/UX Designer</td>";
                    echo "<td>Time Management System</td>";
                    // echo "<td>" . $row['project'] . "</td>";
                    // echo "<td></td>";
                    echo "<td>A1</td>";
                    echo "<td>User Interface And Experience</td>";
                    echo "</tr>";
                }
            }
