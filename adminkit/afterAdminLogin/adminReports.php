    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                <div class="card">
                    <div class="card-body">
                        <form action="adminReports2.php" method="POST">
                            <h5 class="card-title">Generate Report</h5>
                            <div class="mb-3 mt-4">
                                <label for="Employee id" class="form-label">Employee ID<span
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" name="startDate" class="form-control" placeholder="from date"
                                        aria-label="City" required>
                                </div>
                                <div class="col-sm-6">
                                    <label for="">End Date<span class="required">*</span></label>
                                    <input type="date" name="endDate" class="form-control" placeholder="to date"
                            ...
                            <center>
                                <button type="submit" name="submit" class="btn btn-outline-dark"
                                    style="margin-right:18px">Generate Report</button>
                            </center>
                        </form>
                    </div>
                </div>
