    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                ?>
                <button id="myBtn" class="btn btn-primary mb-5">+ Add Activity Code</button>
                <div id="myModal" class="modal ">
                    <!-- Modal content -->
                    <div class="modal-content rounded">
                        <div class="modal-header">
                            <span class="close">&times;</span>
                            <h2 class="mt-3">Add Activity Code</h2>
                        </div>
                        <hr>
                        <div class="modal-body">
                            <div class="imageinmodal">
                                <center><img src="../src/img/ASDR LOGO.png" alt="" width="100" height="50">
                                </center>
                            </div>
                            <form action="" method="POST">
                                ...
                                <center><button type="submit" class="btn btn-outline-dark mb-3">Add</button>
                                </center>
                            </form>
                        </div>
                    </div>
