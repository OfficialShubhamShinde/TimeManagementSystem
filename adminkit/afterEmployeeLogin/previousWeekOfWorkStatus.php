...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $weekno = $_GET['weekno'];
    $lastmondaydate = $_GET['lastmondaydate'];
}
?>

<?php 
// Get the date of the next Monday after the fetched start date
$monday = date('Y-m-d', strtotime('last Monday', strtotime($lastmondaydate)));
    ...
    <div class="wrapper">
            ...
            if ($rowCount != 0) {
                ...
                <center>
                        ...
                        <div class="panel">
                            ...
                            <br>
                                    ...
                                    <center>
                                        ...
                                        if ($fatchEditableOrNot['status'] == 1) {
                                            echo '
                        <div class="row">
                            <div class="col-sm-6">
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Error!</strong> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis, quae?
                    </div>
                    ';
                                        }
        ...
        <nav aria-label="...">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <?php echo '<a class="page-link text-secondary-emphasis" onclick="return checkWeekno()" href="previousWeekOfWorkStatus.php?id=' . $id . '&weekno=' . ($weekno - 1) . '&lastmondaydate='.$monday.'">Previous Week</a>'; ?>
                </li>
...
function checkWeekno() {
  if(<?php echo $weekno ?> == 1) {
    alert("Its your current page. Please select a valid week.");
